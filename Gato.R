...
########################
# Gato - adatado de Tic Tac toe de Dammer#
########################
...
tic.tac.toe <- function(name="Name", mode=0, type=0){
  ...
  if(mode==0) title(list(paste("Gato de", name), cex=2), 
                    "2P : Humano v.s. Humano", font.sub=2, cex.sub=2)
  if(mode==1) title(list(paste("Gato de ", name), cex=2), 
                    "1P : Humano v.s. AI (Facil)", font.sub=2, cex.sub=2)
  if(mode==2) title(list(paste("Gato de ", name), cex=2), 
                    "1P : Humano v.s. AI (Dificil)", font.sub=2, cex.sub=2)
...
line <- function(){
  ...
  if(total.1==0 | total.2==0 | total.3==0 | total.4==0 | total.1==3 | total.2==3 | total.3==3 | total.4==3){
    ...
    if(total.1==0 | total.2==0 | total.3==0 | total.4==0){
      title(sub=list("Has ganado, ¡felicidades John Connor!", col="red", font=2, cex=2.5), line=2)
    }else{
      title(sub=list("!Skynet ha ganado!", col="darkblue", font=2, cex=2.5), line=2)
    }
  }
  ...
  if(all(is.na(place.na))){
    if(total.1==0 | total.2==0 | total.3==0 | total.4==0 | total.1==3 | total.2==3 | total.3==3 | total.4==3){
      if(total.1==0 | total.2==0 | total.3==0 | total.4==0){
        title(sub=list("Has ganado, ¡felicidades John Connor!", col="orange", font=2, cex=2.5), line=2)
      }else{
        title(sub=list("!Skynet ha ganado!", col="darkblue", font=2, cex=2.5), line=2)
      }
    }else{
      title(sub=list("¡Empate !", col="blue", font=2, cex=2.5), line=2)
    }
  }
}
